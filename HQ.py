...
# class vehicle:
#     def __init__(self,name,model,__price):
#         self.name = name
#         self.model = model
#         self.__price = 200      #private attribute daydia ab price change nhi hogi
#     def func(self):
#         print("car name is" ,self.name)
#         print("car model is" ,self.model)
#         print("car price is" ,self.__price)
...
# q1=vehicle("camry",2011,500) #yaha price change ki laikin 200 hi price aiga
# q1.func()
# p1=car("honda",2020,300)
# p1.mycar()
